...
Итого: ~12000 баллов максимально может получить студент за семестр (без устного экзамена).

(Градация может быть пересмотрена, но приблизительно расчитваю на это)

За 10к готов поставить 5.
